 ...
 */
	public function index() {
	    ...
	    $this->loadModel('Income');
            ...
            $incomes = $this->Income->find('all', array('fields'=>array('sum(Income.paid) AS inc'), 'conditions' => $where));
            //$expenses = $this->Expense->find('all', array('fields'=>array('sum(Expense.paid) AS exp'), 'conditions' => $where));
