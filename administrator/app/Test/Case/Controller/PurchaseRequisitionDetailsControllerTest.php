<?php
App::uses('PurchaseRequisitionDetailsController', 'Controller');

/**
 * PurchaseRequisitionDetailsController Test Case
 *
 */
class PurchaseRequisitionDetailsControllerTest extends ControllerTestCase {
