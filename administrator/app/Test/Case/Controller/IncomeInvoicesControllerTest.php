<?php
App::uses('IncomeInvoicesController', 'Controller');

/**
 * IncomeInvoicesController Test Case
 *
 */
class IncomeInvoicesControllerTest extends ControllerTestCase {
 ...
 */
	public $fixtures = array(
		...
		'app.expense_invoice',
		'app.expense_invoice_attachment',
