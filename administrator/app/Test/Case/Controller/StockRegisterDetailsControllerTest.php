<?php
App::uses('StockRegisterDetailsController', 'Controller');

/**
 * StockRegisterDetailsController Test Case
 *
 */
class StockRegisterDetailsControllerTest extends ControllerTestCase {
