<?php
App::uses('PurchaseRequisition', 'Model');

/**
 * PurchaseRequisition Test Case
 *
 */
class PurchaseRequisitionTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PurchaseRequisition = ClassRegistry::init('PurchaseRequisition');
	}
