<?php
App::uses('StockRegister', 'Model');

/**
 * StockRegister Test Case
 *
 */
class StockRegisterTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->StockRegister = ClassRegistry::init('StockRegister');
	}
