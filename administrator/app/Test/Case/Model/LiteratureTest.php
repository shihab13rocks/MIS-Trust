<?php
App::uses('Literature', 'Model');

/**
 * Literature Test Case
 *
 */
class LiteratureTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->Literature = ClassRegistry::init('Literature');
	}
