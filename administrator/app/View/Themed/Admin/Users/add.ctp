		...
		<div class="portlet-body">
			...
			?>
				...
				<?php
					...
					echo $this->Form->input('compare_password', array(
						'class' => 'form-control',
					...
					<!--div class="control-group required">
						<label class="control-label" for="UserPassword"><?php echo __('Confirm Password'); ?></label>
						<div class="controls with-tooltip required">
						<?php echo $this->Form->password('compare_password', array(
							'class' => 'form-control',
							'placeholder' => 'Retype your password'
						)); ?>						
						</div>
